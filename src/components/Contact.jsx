        ...
        <form action="#" className="space-y-2">
          ...
          <div className="sm:col-span-2">
            ...
            <textarea
              ...
              placeholder="Zde se rozepište"></textarea>
          </div>
          <button
            type="submit"
            className="py-3 px-10 transition-colors text-sm font-medium text-center text-white rounded-lg bg-main sm:w-fit hover:bg-blue-700 focus:ring-4 focus:outline-none focus:ring-primary-300 dark:bg-primary-600 dark:hover:bg-primary-700 dark:focus:ring-primary-800">
            Odeslat
          </button>
        </form>
      </div>
