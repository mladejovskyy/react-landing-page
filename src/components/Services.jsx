    ...
    <div className="services lg:px-8 md:px-4">
      <div id="Reality" className="service flex container mx-auto mt-44 md:mt-32">
        <div className="left w-6/12 my-auto md:w-full">
          ...
          <p className="text-paragraph text-lg mt-5 w-11/12 lg:text-base lg:w-full md:text-base md:w-full">
            ...
            dlouhodobým ziskem. Začněte investovat do nemovitostí ještě dnes a
            sledujte, jak se vaše peníze rozvíjejí s každým novým projektem.
            Investujte do budoucnosti s námi!
          </p>
          <motion.button
            whileHover={{ y: -2 }}
            type="button"
            className="text-white transition-colors mt-8 bg-main hover:bg-blue-600 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-lg px-20 py-3.5 me-2 mb-2 dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800">
            Zjistit více
          </motion.button>
        </div>
      ...
      <div id="Akcie" className="service flex container mx-auto mt-8">
        <div className="left m-0 p-0 rounded-xl">
          <img
            className="sluzby-foto rounded-xl mr-auto drop-shadow-lg"
            src="src/assets/akcie.png"
            alt=""
          />
        </div>
        <div className="right w-6/12 my-auto">
          ...
          <p className="text-paragraph text-lg mt-5 w-11/12 lg:text-base lg:w-full">
            ...
            finanční úspěch ještě dnes a sledujte, jak roste vaše investované
            jmění. Investujte do akcií s námi a otevřete dveře k novým
            příležitostem na finančním trhu!
          </p>
          <motion.button
            whileHover={{ y: -2 }}
            type="button"
      ...
      <div id="Komodity" className="service flex container mx-auto mt-8 mb-24">
        <div className="left w-6/12 my-auto">
          ...
          <p className="text-paragraph text-lg mt-5 w-11/12 lg:text-base lg:w-full">
            ...
            investice vyvíjejí v dynamickém světě komoditních trhů. Začněte
            investovat ještě dnes a objevte nové perspektivy pro váš finanční
            úspěch!
          </p>
          <motion.button
            whileHover={{ y: -2 }}
